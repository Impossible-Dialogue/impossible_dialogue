...
PATTERNS = {
    ...
    '0x3': PatternConfig("ColorDistributionPattern", dict(color=np.array([0, 255, 127], dtype=np.uint8))),
    '1x3': PatternConfig("ColorDistributionPattern", dict(color=np.array([0, 127, 255], dtype=np.uint8))),
    '2x3': PatternConfig("ColorDistributionPattern", dict(color=np.array([0, 127, 127], dtype=np.uint8))),
    '3x3': PatternConfig("ColorDistributionPattern", dict(color=np.array([127, 127, 0], dtype=np.uint8))),
    '4x3': PatternConfig("ColorDistributionPattern", dict(color=np.array([127, 255, 0], dtype=np.uint8))),
    '5x3': PatternConfig("ColorDistributionPattern", dict(color=np.array([127, 0, 127], dtype=np.uint8))),
    '6x3': PatternConfig("ColorDistributionPattern", dict(color=np.array([127, 0, 255], dtype=np.uint8))),
    '7x3': PatternConfig("ColorDistributionPattern", dict(color=np.array([127, 255, 127], dtype=np.uint8))),
